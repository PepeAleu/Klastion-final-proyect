...
namespace PrimerJuego
{
    ...
    public class SpriteManager : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        public override void Initialize()//+++++++++++++++++++++++         INITIALIZE        +++++++++++++++++
        {
            ...
            Suelo(posicionTerrenoX, posicionTerrenoY, 300, -120, terrenoList, 0.542f);
            Escaleras(posicionTerrenoX, posicionTerrenoY + 400, 300, 30, 10, terrenoList, 0.550f, true);
            Escaleras(posicionTerrenoX, posicionTerrenoY, 450, -20, 5, terrenoList, 0.550f, true);
            this.posicionTerrenoX += 850;
            Escaleras(posicionTerrenoX, posicionTerrenoY, 130, 5, 20, terrenoList, 0.550f, true);
            PuntoControlTigre(posicionTerrenoX + 350, posicionTerrenoY - tigres[0].getFrameSize.Y + 30);
            puntosControl.Add(-posicionTerrenoX + 350);

            Suelo(posicionTerrenoX, posicionTerrenoY, 750, -20, terrenoList, 0.540f);
            SueloChico(posicionTerrenoX, posicionTerrenoY, 750, 0, 0, terrenoList);
            SueloChico(posicionTerrenoX, posicionTerrenoY, 350, 0, 1, terrenoList);
            SueloChico(posicionTerrenoX, posicionTerrenoY, 350, 0, 6, terrenoList);
            Suelo(posicionTerrenoX, posicionTerrenoY, 350, -20, terrenoList, 0.540f);
            PuntoControlTigre(posicionTerrenoX + 150, posicionTerrenoY - tigres[0].getFrameSize.Y + 30);
            puntosControl.Add(-posicionTerrenoX + 150);

            SueloChico(posicionTerrenoX, posicionTerrenoY, 750, 0, 3, terrenoList);
            Suelo(posicionTerrenoX, posicionTerrenoY, 350, 0, terrenoList, 0.540f);
            SueloChico(posicionTerrenoX, posicionTerrenoY, 750, 0, 4, terrenoList);
            Suelo(posicionTerrenoX, posicionTerrenoY, 350, 0, terrenoList, 0.540f);
            SueloChico(posicionTerrenoX, posicionTerrenoY, 750, 0, 5, terrenoList);
            Suelo(posicionTerrenoX, posicionTerrenoY, 350, 0, terrenoList, 0.540f);
            final = new Mapa(
            ...
            Escaleras(posicionTerrenoX + 600, posicionTerrenoY, 300, -30, 10, terrenoList2, 0.210f, true);
            Escaleras(posicionTerrenoX + 1500, posicionTerrenoY, 50, 10, 10, terrenoList2, 0.210f, true);
            Escaleras2(posicionTerrenoX + 3000, posicionTerrenoY-100 , -300, 20, 10, terrenoList2, 0.210f, false);
            //SegundoPlano();
        ...
        {
            texto = "Estado " + currentGravedadState;
